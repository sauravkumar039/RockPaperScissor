...
rock[0].addEventListener("click", function () {
  ...
  if (computerInput == "Rock") {
    ...
    document.body.classList.add("pcbuttonPage3Paper-active");
    document.body.classList.add("youbuttonPage3Rock-active");
...
paper[0].addEventListener("click", function () {
  ...
  if (computerInput == "Rock") {
    ...
    document.body.classList.add("page1-active");
    document.body.classList.add("page2-active");
    document.body.classList.add("youbuttonPaper-active");
    document.body.classList.add("pcbuttonRock-active");
  } else if (computerInput == "Paper") {
    console.log("tie");
    document.body.classList.add("page1-active");
    document.body.classList.add("page4-active");
...
playagain[0].addEventListener("click", function () {
  ...
  document.body.classList.remove("youbuttonPaper-active");
    document.body.classList.remove("pcbuttonRock-active");
});
...
playagain3[0].addEventListener("click", function () {
  ...
  document.body.classList.remove("pcbuttonPage3Paper-active");
    document.body.classList.remove("youbuttonPage3Rock-active");
});
